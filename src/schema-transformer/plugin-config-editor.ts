...
export const buildBooleanSchema = (_fieldSchema: BooleanFieldSchema): ExtendedJSONSchema => {
  return {
    type: 'boolean',
  }
}
...
export const buildUnknownSchema = (_fieldSchema: FieldSchema): ExtendedJSONSchema => {
  return {
    detail: 'unknown',
